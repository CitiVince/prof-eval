...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.professor'
        db.add_column('evals_comment', 'professor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['evals.Professor'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.professor'
        db.delete_column('evals_comment', 'professor_id')

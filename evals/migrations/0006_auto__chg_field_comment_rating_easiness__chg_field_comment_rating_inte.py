...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Comment.rating_easiness'
        db.alter_column('evals_comment', 'rating_easiness', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))

        # Changing field 'Comment.rating_interesting'
        db.alter_column('evals_comment', 'rating_interesting', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))

        # Changing field 'Comment.rating_overall'
        db.alter_column('evals_comment', 'rating_overall', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))

        # Changing field 'Comment.rating_niceness'
        db.alter_column('evals_comment', 'rating_niceness', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))

        # Changing field 'Comment.rating_clarity'
        db.alter_column('evals_comment', 'rating_clarity', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))
    ...
    models = {
        'evals.comment': {
            ...
            'rating_clarity': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '1'}),
            'rating_easiness': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '1'}),
            'rating_interesting': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '1'}),
            'rating_niceness': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '1'}),
            'rating_overall': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '1'}),
